...
Part 1's own example is the proof, and it was hiding in plain sight. The neutral, MEV-resistant batch-auction venue exists and works. But it cannot stand on its own in an extractive sea. It survives only by sourcing its liquidity from the very extractive base it was built to escape, which turns it from a replacement for that base into a skin stretched over it. The fair island did not defeat the extractive ocean. The ocean absorbed it and kept the island alive as a feature of itself. That is not a market underproviding a public good. That is a market digesting the antibody.

So fairness has a binary that most people miss because they imagine a spectrum. They think the choice is between cheap fairness and expensive fairness, a little now or a lot later. It is not. The choice is between fairness baked into the substrate at a bounded, known cost, and no fairness at all. There is no middle option, because the middle option is the bolt-on, and the bolt-on is exactly the thing that gets cannibalized. You either pay the bounded cost once, at the base, to make the whole structure positive-sum, or you pay nothing and get nothing, because anything you build on top is absorbed by what is underneath it.
