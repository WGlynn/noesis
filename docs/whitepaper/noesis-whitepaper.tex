...
\texttt{noesis}}
\date{Version 2.5 \quad June 2026}
...
in contribution: it measures the value of a contribution on-chain and makes that measurement the object
consensus is about, not who holds the coin but how much each participant actually contributed. The claim
