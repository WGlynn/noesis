...
\texttt{noesis}}
\date{Draft 1.1 \quad June 2026 \\[2pt] \footnotesize\textcolor{bad}{Confidential pre-release. Not for redistribution.}}
...
present strength is measured (Figure~\ref{fig:moat}) rather than asserted.
...
Section~\ref{sec:fairlaunch} from forks of this chain to all chains: importing a rival's contributions
honestly adds them to the same attribution graph, so there is no outside to fork to, and forking, which
fragments value elsewhere, here becomes contribution.
