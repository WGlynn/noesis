...
3. [ ] **ROADMAP.md** — - **2026-06-17 (k)** — DESIGN tick (no code; PCP-gate — (j) already shipped a delicate moat build THIS session at ~246k context, and a 2nd in the same tired window is exactly what the gate guards). Advances the (j) NEXT target — ON-VM singl...
