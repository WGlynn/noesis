...
- [ ] CONTINUE.md — - **NAMING (Will: "neutral everywhere"):** "Will's Equilibrium" → **Honest-Contribution Equilibrium (HCE)** across all active surfaces (roadmap spine, `node/src/lib.rs` comments, ROADMAP.md, STUDY-GUIDE.md,
...
- [ ] DESIGN-adaptive-convergence-theorem.md — The measure `v` is retrained on the behavior it induces. Borrowing the performative-prediction frame (Perdomo, Zrnic, Mendler-Dünner, Hardt 2020):
...
- [ ] DESIGN-peg-proof-template-for-hce.md — - **PEG — Peer Elicitation Games** (Chen, Zhu, Han, B. Li, G. Li, Dai; arXiv:2505.13636, May→Oct 2025). A training-free game: one generator + multiple discriminators instantiated from *distinct* base models;
...
- [ ] DESIGN-wills-equilibrium.md — Proof of Mind reaches an equilibrium where honest contribution **and** honest self-reporting is the profile no one wants to leave — and it stays that way not only against unilateral and coalition deviations (standard, achievable with a fixe...
...
- [ ] MOAT-STACK.md — | # | moat | axis | what it is | status | |---|---|---|---|---| | 1 | cooperative-economic structure | **WHAT** is consensus-ed | consensus on contribution VALUE (not order), no ground-truth oracle: the Contribution Consensus Problem solved...
...
- [ ] ROADMAP-LEAN-INTO-EDGE.md — **Narrow + specific + paper-stage:** (a) the *no-immediate-oracle* framing of the Contribution Consensus Problem; (b) topology-only collusion detection that does NOT need an honest stake majority (HodgeRank
