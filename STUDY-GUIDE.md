...
- [ ] CONTINUE.md — - **Will-ordered in-chat ("noesis roadmap execution story mode form") past rotation threshold — single increment, done right:** `onchain/pom-typescript` now iterates its WHOLE script group (Source::GroupInput until IndexOutOfBound; empty gr...
