...
- [ ] README.md — **The first blockchain whose relationship to other chains is non-zero-sum.** Instead of fighting for one useful-work standard, noesis absorbs rivals by conserving their contributions into one canonical attribution graph: a chain that conver...
