...
3. [ ] **ROADMAP.md** — - **2026-06-20 (dd)** — DESIGN tick (no code; PCP-gate — (cc) already shipped a moat BUILD this session, and the next step is slash-PATH surgery = the dispute-settlement trust boundary = highest blast radius ⇒ decide now, build fresh, per t...
