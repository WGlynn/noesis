...
3. [ ] **ROADMAP.md** — - **2026-06-19 (u)** — BUILT ✅ **T3 CLOSED** — the hybrid-split diagonal pump is closed by replacing the product-of-two-tails with a **single joint geometric decay**. The (q)/(r) fix damped within-identity (λ^r) and cross-identity (μ^m) on ...
