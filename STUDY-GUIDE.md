...
3. [ ] **ROADMAP.md** — - **2026-06-14** — RSAW follow-tick: the identity-separated PoM-cartel residual is CLOSED via **§7.1c dimension-level recusal**. The appeal court down-weights PoM (the captured axis): `DISPUTE_APPEAL` mix pow:pos:pom = 0.225:0.675:0.10 (NCI...
