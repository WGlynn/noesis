...
- [ ] CONTINUE.md — - **⚠ PATHS MOVED.** This file is now `internal/CONTINUE.md` (boot hook updated). The 27 root `.md` were restructured to make noesis read as a chain, not an essay folder. Benchmarked vs the live bitcoin / go-ethereum / nervos-ckb / solana r...
