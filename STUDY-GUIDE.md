...
3. [ ] **ROADMAP.md** — - **2026-06-16 (b)** — DESIGN NOTE (not built; surfaced in a public-thesis session, captured here): an orthogonal family for un-gameable `v(S)` — **elicit, don't measure**. Phase 1 currently assumes `v(S)` must be MEASURED (learned reward-m...
