...
- [ ] CONTINUE.md — - **DESIGN tick (no code; PCP-gate — fresh session @ ~250k after an unrelated heavy build hour).** Advances the (k)-pinned PREREQUISITE (#4-next token-state persistence) named→DECIDED. - **GROUNDED FINDING:** `Node::apply` (`runtime.rs:332`...
