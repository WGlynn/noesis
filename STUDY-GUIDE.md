...
3. [ ] **ROADMAP.md** — - **2026-06-19 (v)** — DESIGN tick (no code; PCP-gate — this fire batched with 5 other cron loops in a session already carrying large context, and the lock-sig change touches `is_valid_in_ledger` = the
