...
- [ ] REFERENCE-NODE-STATUS.md — --- title: "Noesis Reference Node v0.1 — Status" subtitle: "Prove-me-wrong audit, 2026-07-02" date: "2 July 2026" ---
...
- [ ] ROADMAP-2026-2028.md — Before SDK/testnet: 10–15 pages, not marketing, not legal. Answers: why does Noesis exist · what problem · what are the invariants · what trade-offs · where should it NOT be used · how are future protocol changes evaluated. Becomes the phil...
...
- [ ] decorrelated-adversarial-review.md — --- title: "Decorrelated Adversarial Review (DAR)" subtitle: "A repeatable practice for exposing blind spots, and a note on how it was used to build this" date: "2 July 2026 (v2)" ---
