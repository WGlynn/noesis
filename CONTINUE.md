...
flowchart LR
  subgraph DONE["✅ Demonstrated (tested)"]
    ...
    d7["consensus: 2/3 finalization + retention-decay + RSAW self-audit (eclipse→quorum-floor, sybil, slashability) + value-layer adversary (provenance-forgery, quality-bound) (44/44)"]
  end
